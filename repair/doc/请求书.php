...
<br><table width="55%" border="1">
          <tbody>
            ...
            <tr>
              <td>振込先</td>
              <td>三菱UFJ銀行 西池袋支店<br>普通　0717009 <br>ユウソリューションズ（カ </td>
            </tr>
          </tbody>
        </table>      
<br>
      ...
      <table width="100%" border="0">
        <tbody>
          <tr>
            <td width="33%">⽇付</td>
            <td width="10%">:</td>
            <td align="right" width="57%">' . $data_info[ 'invoice_date' ] . '</td>
          </tr>
          <tr>
            <td width="33%">請求書番号</td>
            <td>:</td>
            <td align="right" width="57%">' . $data_info[ 'invoice_sn' ] . '</td>
          </tr>
		  <tr>
...
$pdf->Output( $data_info[ 'invoice_date' ] . 'QQS' . $id . '.pdf', 'D' );
