...
.site-doc-icon li{display: inline-block; vertical-align: middle; width: 120px; line-height: 25px; padding: 20px 0; margin-right: -px; margin-bottom: -1px; border: 1px solid #e2e2e2; font-size: 14px; text-align: center; color: #666; transition: all .3s; -webkit-transition: all .3s;}
...
<button type="button" class="layui-btn layui-btn-warm">暖色按钮</button>
				...
				<div class="layui-card-body">
					<ul class="site-doc-icon">
						<li>
							<img height="180px" width="300px" src="<?php echo base_url()?>appoint/vehicle/2020112014404336384.jpg" class="layui-upload-img">
