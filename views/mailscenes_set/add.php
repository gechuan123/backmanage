...
<div class="x-body">
    <form class="layui-form" action="javascript:;" id="form">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea name="header" lay-verify="header" placeholder="" class="layui-textarea" maxlength="250"></textarea>
            </div>
        </div>
		<div class="layui-form-item layui-form-text">
            <label class="layui-form-label">FOOTER：</label>
            <div class="layui-input-block">
                <textarea name="footer" lay-verify="footer" placeholder="" class="layui-textarea" maxlength="250"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea name="remark" placeholder="" class="layui-textarea" maxlength="250"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
    ...
    form.on('submit(add)', function(data){
		var index = layer.confirm('よろしいですか？', {icon: 3, title:'荻原建設',btn: ['確定', 'キャンセル']}, function(){
			$.ajax({
				...
				type: 'POST',
				data: {title:data.field.title,header:data.field.header,footer:data.field.footer,sort:data.field.sort,status:data.field.status,remark:data.field.remark},
				dataType: 'JSON',
