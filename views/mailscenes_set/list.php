...
<body>
<div class="x-nav">
    <span class="layui-breadcrumb"><a href="javascript:;">メール管理</a><a href="javascript:;">メール設定</a></span>
...
<div class="x-body">
	...
	<xblock>
        <?php echo btn_list($this, ['forbidden', 'recover'], $count); ?>
    </xblock>
    <?php echo $page; ?>
</div>
<script>
