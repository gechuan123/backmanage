    ...
    <form class="layui-form" action="javascript:;" id="form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="realname" lay-verify="realname" placeholder="会員名 長さ6-16間。" autocomplete="off" class="layui-input" value="<?php echo $realname;?>" maxlength="16">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="password" name="confirmPw" lay-verify="confirmPw" placeholder="入力してください" autocomplete="off" class="layui-input" maxlength="16">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">メールボックス账号：</label>
            <div class="layui-input-block">
                <input type="text" name="email" lay-verify="email|db_email" placeholder="入力してください" autocomplete="off" class="layui-input" value="<?php echo $email;?>" >
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">電話番号：</label>
            <div class="layui-input-block">
                <input type="text" name="mobile" lay-verify="mobile|db_mobile" placeholder="入力してください" autocomplete="off" class="layui-input" value="<?php echo $mobile;?>" maxlength="20">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    form.verify({
		...
		db_mobile: function(value, item)
		{
			...
			$.ajax({
				...
				type: "POST",
				data: {mobile: $('input[name=mobile]').val(),id: $('input[name=id]').val()},
				async: false,
				success: function(result){
					if(result == '1'){
						ischeck = '電話番号重複できません';
