    ...
    <form class="layui-form" action="javascript:void(0);" id="form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="typename" lay-verify="typename" placeholder="機種 長さ2-16間。" autocomplete="off" class="layui-input" maxlength="16">
            </div>
        </div>
		<div class="layui-form-item">
            <label class="layui-form-label">番号：</label>
            <div class="layui-input-block">
                <input type="text" name="number_no" lay-verify="number_no" placeholder="番号 長さ6-32間。" autocomplete="off" class="layui-input" maxlength="32">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    form.on('submit(add)', function(data){
		var index = layer.confirm('よろしいですか？', {icon: 3, title:'荻原建設',btn: ['確定', 'キャンセル']}, function(){
			$.ajax({
				...
				type: 'POST',
				data: {typename:data.field.typename,number_no:data.field.number_no,sort:data.field.sort,remark:data.field.remark},
				dataType: 'JSON',
